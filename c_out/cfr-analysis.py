...
page_text = {
    "Intro-Context": "  ".join([
        ...
        "In 2024, the CFR consisted of 50 titles, which contain over 9,000 parts, which contain over 400,000 sections, which contain roughly 300 million words of regulations.",
        "Federal regulation is likely unavoidable because of the complexity and scale of a modern country, especially a high-capability country like the United States.",
    ...
    "Intro-Theory":"  ".join([
        ...
        "In this project, I measure how well each section fits with other sections in the same part.",
    ...
    "Intro-Approach":"  ".join([
        ...
        "My dissimilarity score ranges from 0 (perfectly similar) to 0.5 (unrelated) to 1.0 (contradictory), but most sections fall between 0 and 0.1 because CFR is topically organized.",
    ...
    "Dissimilarity-Histogram-1":"  ".join([
        "The bar chart (right) shows the average dissimilarity scores for each part in the selected title.",
        "The height of each bar shows the average dissimilarity score across all sections in that part.",
    ...
    "Dissimilarity-Histogram-2":"  ".join([
        "To illustrate what these scores mean substantively, select Title 31, Part 586 (31 CFR 586).",
        "This part has an average dissimilarity score of 0.41 (high for a CFR part) and concerns sanctions against China's military-industrial complex.",
    ...
    "Chapter-Temporal": "  ".join([
        "CFR regulations evolve in response to legislative events, executive priorities, trends, innovations, etc.",
        "These charts (below) show how the selected part changed over time and how part size relates to executive/legislative mandates.",
        "For example, select 31 CFR 586.",
        "This part was introducted in 2022 to implement two executitive orders, which, in turn, address weaknesses in previous sanctions (left chart).",
        "The text has remained unchanged since then (middle chart).",
        "Looking across Title 31 as a whole, we can see that parts with many authorities tend to have more sections, but parts with many sections may or may not cite many authorities (right chart).",
    ...
    "Chapter-Methodology": "  ".join([
        ...
        "To see my other non-work coding projects, visit my GitHub gallery page: ",
        ]),
    "Step-1": " ".join([
        ...
        "For a production pipeline, the script could be scheduled to run periodically to keep the data up to date over time.",
    ...
    "Step-2": " ".join([
        ...
        "From there, the script parses the data into PySpark dataFrames, and cleans the data with extensive Spark CPU parallelism.",
        "The final parquet files are stored in the a_in/cfr_parsed_section, and a_in/cfr_parsed_part directories.",
        "During initial code development, the script successfully processed 981 Mb of raw XML files into 1.8 Gb of cleaned Parquet dataset files.",
    ...
    "Step-3": " ".join([
        ...
        "It generates individual text embeddings for the 1.5M sections from the 2024 CFR using a pre-trained transformer model.",
        ...
        "Future development (medium priority) will also extend embedding calculations to all years of data, not just 2024."
        ]),
    "Step-4": " ".join([
        " executes the fourth step of the project, using PySpark and NumPy to quantify key aspects of the CFR.",
        "Statistics and metrics include:",
        ...
        "(4) Percentage of part's sections that are identical to the most recent downloaded year of text (2024), as measured using exact text hash matching.",
        "(5) Semantic dissimilarity scores comparing each section's embedding to the average embedding across all sections in that part.",
        "Semantic dissimilarity is measured using cosine distance between text embeddings, and is rescaled to range from 0.0 (semantically identical) to 1.0 (contradictory).",
        "In addition, the script identifies which sections are the most and least typical section in each part.",
